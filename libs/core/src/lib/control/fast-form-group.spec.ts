...
describe('FastFormGroup', () => {
  ...
  describe('addControl', () => {
    ...
    it('should add action', () => {
      const formGroup = new FastFormGroup(null, controlFactory);
  ...
  describe('get', () => {
    ...
    it('should return null if control not found', () => {
      const formGroup = new FastFormGroup(null, controlFactory);
      const child1 = new FastFormGroup(null, controlFactory);
    ...
    it('should get form action from deep group', () => {
      const formGroup = new FastFormGroup(null, controlFactory);
      const child1 = new FastFormGroup(null, controlFactory);
      const child2 = new FastFormGroup(null, controlFactory);
      formGroup.addControl('child1', child1);
